...
//#define ENABLE_BATTLE_TESTER 1
	...
	static std::string APP_VERSION = "1.2.3";
#else
#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
	static std::string APP_VERSION = "1.4";
#else
...
/* URL define */
	...
	static std::string URL_DS_USER      = "u.m543.com.cn";//"http://10.103.252.68:9999"; //"http://10.103.252.39:522";
	static std::string URL_USER_MAPPING = "login.m543.com.cn"; //"http://10.103.252.68:8081"; //"http://10.103.252.39:8999"; 
	static std::string URL_DS_PAYMENT   ="http://10.103.252.39";
	static std::string URL_PAY_NOTIFY   = "http://10.103.252.39:9003";
...
#elif (defined ANDROID_GOOGLEPLAY_SC) || (defined ANDROID_GOOGLEPLAY_CT) || (defined ANDROID_PAYPAL) || (defined APPSTORE)
